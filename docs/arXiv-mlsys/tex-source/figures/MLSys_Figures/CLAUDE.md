# prefix_hit_maximization.svg — Figure Description

The figure illustrates a key step of the Greedy Group Recursion algorithm (prefix hit maximization).
All gaps between adjacent areas are 10px, except the gap between Top and Bottom groups in the Right section which is 40px.
