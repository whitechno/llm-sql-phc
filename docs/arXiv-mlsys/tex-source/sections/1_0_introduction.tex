...
GGR algorithm optimizes LLM queries by finding a ($n \times m$) table re-arrangement
...
The re-arranged table is represented as a list of tuples $L$, where each tuple
